    ...
    class PongGame : pongSettings
    {
        ...
        public PongGame(Texture2D playerOneTexture, Texture2D playerTwoTexture, Texture2D barrierTexture, Texture2D gameBallTexture, GraphicsDeviceManager graphics, int numOfUsers)
        {
            ...
            if(Game1.gameSettings.barriers == true)
            {
                if (numOfUsers == 1)
                {
                    P1 = new clsPlayer(playerOneTexture, PlayerType.PlayerOne, new Vector2(graphics.PreferredBackBufferWidth - 1276, (graphics.PreferredBackBufferHeight / 2) - 232), new Vector2(51, 235), new Vector2(graphics.PreferredBackBufferWidth, graphics.PreferredBackBufferHeight));
                    P2 = new clsPlayer(playerOneTexture, PlayerType.CPU, new Vector2(75, (graphics.PreferredBackBufferHeight / 2) - 232), new Vector2(51, 235), new Vector2(graphics.PreferredBackBufferWidth, graphics.PreferredBackBufferHeight));
